...
class ArrayList(List):
    ...
    def __init__(self):
        ...
        '''
        #number of elements in a set to 0 initially
        #j index of first element in a. set to 0 initially
        #a is the backing array a[(i+j) mod length(a)] stores i
        self.n = 0
        self.j = 0
    ...
    def add(self, i : int, x : object) :
        '''
            ...
            Inputs:
                ...
                x: Object type, i.e., any object
        '''
        if i < 0 or i > self.n: raise IndexError("Index out of Bounds")
        ...
        if i < self.n//2:
            ...
            for k in range(self.n, i, -1):
                #i+1
                self.a[(self.j+k) % len(self.a)] = self.a[(self.j+k-1) % len(self.a)] #-1
